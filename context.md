...
| ANLART   | Cod SAP pentru tipul de instalatie |
| AR       | Ansamblu de Reglare |
| ARBPL    | Post de lucru | Field din SAP folosit si in DTL | 
| ATR      | Aviz Tehnic de Racordare |
| AUART    | SAP Code - cod pentru comanda de lucru |
| AUFNR    | SAP ID - numar de identificare record SAP |
| AUFTEXT  | Descriere comanda de lucru SAP |
| BVGM     | Buletin Verificare Grup Masura |
| BMC      | Bon Miscare Contor |
| BMMM     | Buletin Miscare Mijloc Masurare |
| CONLOC   | Loc conectare |
| CP       | Control Periodic |
| CRC      | Centrul Relatii Clienti |
| CRE      | Cerere de Retragere din Exploatare |
| DD       | Dispecer Distributie | 
| DEREGSTAT | Eligibil |
| DME      | Departament Management Energie |
| DMS      | Document Management System |
| DSL      | Domain Specific Language |
| EER      | E.ON Energie Romania |
| EIP      | Echipamente Individuale de Protectie |
| ERP      | Enterprise Resource Planning |
| ESCR     | E.ON Servicii Clienti Romania |
| ESTR     | E.ON Servicii Tehnice Romania |
| ETL      | Extract, Transform, Load |
| FAS      | |
| FFA      | Field Force Automation | Alias for FSMS backend servers |
| FME      | Foaie de Manevra de Executie |
| FME      | | Reporting server for backoffice data |
| FMO      | | |
| FOL      | Formatie Operativa de Lucru |
| FQDN     | Fully Qualified Domain Name |
| FSMS     | Field Service Management System |
| FTL      | |
| FTP      | File Transfer Protocol |
| GIS      | |
| GLTRP    | Task finish date time | 2024-04-16T15:42:17.000+03:00 |
| GLUZP    | Time part for GLTRP | 15:42:17 |
| GMSC     | |
| GSTRP    | Team arrive date time at task location | 2024-04-16T15:40:56.000+03:00 |
| GSUZP    | Time part from GSTRP | 15:40:56 |
| HERST    | Producator |
| HTTP     | Hypertext Transfer Protocol |
| IA       | Interventii Accidentale |
| IR       | |
| IU       | | de exemplu Montare contor in IU | 
| JAX-RS   | Java API for RESTful Web Services |
| JAX-WS   | Java API for XML Web Services |
| LC       | Loc Consum |
| LEA      | Linie Electrica Aeriana |
| LES      | Linie Electrica Subterana |
| LO       | Lucrari Operative |
| M        | Monofazat | Tip instalatie, prin specializare tip contor |
| MCP      | Mobile Computing Platform, alias for FSMS Mobile |
| MESSART  | Tip masurare |
| MST      | Masuratori de Statie |
| NCT      | Nota de Constatare Tehnica |
| ND       | Numarul Documentului | number for change request document, often used to refer to document itself |
| ODS      | Ordin De Servici | variant for OS |
| OL       | Otel | Material for gas pipe |
| OMS      | Outage Management System |
| ORM      | Object-Relational Mapping |
| OS       | Ordin de Servici |
| OSD      | |
| PA-PT    | Punct Alimentare - Post Transformare |
| PE       | Polietilena | Material for gas pipe |
| PIF      | Punere In Functiune |
| PLTXT    | Functional location description |
| PR       | Post Reglare |
| PRAM     | Protectie si Automatizari |
| PREX     | Perstator extern |
| PR/PRM   | Post Reglare / Post Reglare-Masura |
| PTA      | Post Transformare Aeriana |
| PV       | Process Verbal |
| RA       | Reparatii Accidentale |
| REST     | Representational State Transfer |
| RN       | Reparatii Neplanificate |
| RT       | Revizie Tehnica |
| SAP      | Systems, Applications, and Products in Data Processing |
| SAP DM   | SAP Device Management |
| SAP IS-U | SAP Industry-Specific Solution for the Utilities Industry |
| SAP PM   | SAP Plant Maintenance |
| SAP WM   | SAP Work Management | Work Management manages the service order and work order part in IS-U. Anything to do with planning and carrying out internal and external work or services is managed through this module. It has tight integration with PM. |
| SIE      | Serviciul Investigatii Energetice | Analizeaza potentialele fraude |
| SLA      | Service Level Agreement |
| SMC      | Serviciul Management Contracte |
| SME      | Serviciul Monitorizare Energie |
| SMM      | Serviciul Management Masura |
| SN       | Special Network |
| SOAP     | Simple Object Access Protocol |
| SPARTE   | SAP ISU attribute for division, 01 for electricity and 02 for gas |
| SPEBENE  | Nivel de tensiune |
| SPC      | |
| SRM      | Statii de Reglare Masurare |
| SRMP     | Statie de Reglare Masurare Predare |
| SRS      | Statii de Reglare de Sector |
| SSM      | Siguranta si Securitatea Muncii |
| SVN      | Apache Subversion |
| T        | Trifazat | Tip instalatie, prin specializare tip contor |
...
| ZTIPCONT | Tip contor |
| ZVGM     | |
| ZZPM_BU  | SAP ERP attribute for division, 01 for electricity and 02 for gas |
